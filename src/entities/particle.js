    ...
    EntityParticle = ig.Entity.extend({
        ...
        init: function(x, y, settings) {
            ...
            if (this.currentAnim) {
                ...
                this.initialAlpha = this.currentAnim.alpha;
            }
        ...
        update: function() {
            ...
            this.currentAnim.alpha = this.idleTimer.delta().mapClamp(this.lifetime - this.fadetime, this.lifetime, this.initialAlpha, 0);
            this.parent();
        }
    });
